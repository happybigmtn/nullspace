...
export declare const RouletteBetSchema: z.ZodObject<{
    type: z.ZodUnion<[z.ZodEnum<["STRAIGHT", "RED", "BLACK", "EVEN", "ODD", "LOW", "HIGH", "DOZEN_1", "DOZEN_2", "DOZEN_3", "COL_1", "COL_2", "COL_3", "ZERO", "SPLIT_H", "SPLIT_V", "STREET", "CORNER", "SIX_LINE"]>, z.ZodNumber]>;
    amount: z.ZodNumber;
    target: z.ZodOptional<z.ZodNumber>;
...
export declare const CrapsBetSchema: z.ZodObject<{
    type: z.ZodUnion<[z.ZodEnum<[string, ...string[]]>, z.ZodNumber]>;
    amount: z.ZodNumber;
    target: z.ZodOptional<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
    type: string | number;
...
export declare const CrapsSingleBetRequestSchema: z.ZodObject<{
    ...
    betType: z.ZodUnion<[z.ZodEnum<[string, ...string[]]>, z.ZodNumber]>;
    amount: z.ZodNumber;
    target: z.ZodOptional<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
    type: "craps_bet";
...
export declare const HiLoLowerRequestSchema: z.ZodObject<{
    type: z.ZodLiteral<"hilo_lower">;
}, "strip", z.ZodTypeAny, {
    type: "hilo_lower";
}, {
    type: "hilo_lower";
}>;
export declare const HiLoSameRequestSchema: z.ZodObject<{
    type: z.ZodLiteral<"hilo_same">;
}, "strip", z.ZodTypeAny, {
    type: "hilo_same";
}, {
    type: "hilo_same";
}>;
export declare const HiLoCashoutRequestSchema: z.ZodObject<{
    type: z.ZodLiteral<"hilo_cashout">;
}, "strip", z.ZodTypeAny, {
    type: "hilo_cashout";
}, {
    type: "hilo_cashout";
...
export declare const OUTBOUND_MESSAGE_GAME_TYPES: {
    readonly blackjack_deal: GameType.Blackjack;
    readonly blackjack_hit: GameType.Blackjack;
    readonly blackjack_stand: GameType.Blackjack;
    readonly blackjack_double: GameType.Blackjack;
    readonly blackjack_split: GameType.Blackjack;
    ...
    readonly hilo_lower: GameType.HiLo;
    readonly hilo_same: GameType.HiLo;
    readonly hilo_cashout: GameType.HiLo;
    readonly baccarat_deal: GameType.Baccarat;
    readonly casino_war_deal: GameType.CasinoWar;
    readonly casino_war_war: GameType.CasinoWar;
    readonly casino_war_surrender: GameType.CasinoWar;
    readonly casinowar_deal: GameType.CasinoWar;
    readonly casinowar_war: GameType.CasinoWar;
    readonly casinowar_surrender: GameType.CasinoWar;
    readonly video_poker_deal: GameType.VideoPoker;
    readonly video_poker_draw: GameType.VideoPoker;
    readonly videopoker_deal: GameType.VideoPoker;
    readonly videopoker_hold: GameType.VideoPoker;
    readonly sic_bo_roll: GameType.SicBo;
    readonly sicbo_roll: GameType.SicBo;
    readonly three_card_poker_deal: GameType.ThreeCard;
    readonly three_card_poker_play: GameType.ThreeCard;
    readonly three_card_poker_fold: GameType.ThreeCard;
    readonly threecardpoker_deal: GameType.ThreeCard;
    readonly threecardpoker_play: GameType.ThreeCard;
    readonly threecardpoker_fold: GameType.ThreeCard;
    readonly ultimate_tx_deal: GameType.UltimateHoldem;
    readonly ultimate_tx_bet: GameType.UltimateHoldem;
    readonly ultimate_tx_check: GameType.UltimateHoldem;
    readonly ultimate_tx_fold: GameType.UltimateHoldem;
    readonly ultimateholdem_deal: GameType.UltimateHoldem;
    readonly ultimateholdem_bet: GameType.UltimateHoldem;
    readonly ultimateholdem_check: GameType.UltimateHoldem;
    readonly ultimateholdem_fold: GameType.UltimateHoldem;
    readonly faucet_claim: null;
};
export declare function getOutboundMessageGameType(type: OutboundMessage['type']): GameType | null;
/**
