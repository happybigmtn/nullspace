...
*Focus: restoring Testnet stability and removing the "hacky" protocol glue.*
...
*Focus: Visibility into the black box. If it breaks, we need to know why instantly.*
...
*Focus: Proving we can handle the traffic.*
