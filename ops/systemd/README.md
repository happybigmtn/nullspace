...
sudo systemctl enable nullspace-simulator nullspace-node nullspace-auth nullspace-website
sudo systemctl start nullspace-simulator nullspace-node nullspace-auth nullspace-website
```
