 ...
 */
export function wrapSubmission(tx) {
 ...
 */
export function wrapMultipleSubmission(txs) {
 ...
 */
export function generateSessionId(publicKey, counter) {
 ...
 */
export function verifyTransaction(tx, instructionLen) {
    // Extract components
