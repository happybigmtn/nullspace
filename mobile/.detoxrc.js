...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/nullspacemobile.app',
      build: 'xcodebuild -workspace ios/nullspacemobile.xcworkspace -scheme nullspacemobile -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
